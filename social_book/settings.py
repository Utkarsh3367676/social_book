...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'utkarshsingh2622@gmail.com'  # Replace with sender's email
EMAIL_HOST_PASSWORD = 'dggc tlvq myom uxpj'  # Replace with app password or email password
